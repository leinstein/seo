				...
				<div class="weui-tab__bd">
					<div class="weui-tab">
						<div class="weui-navbar">
							...
							<a class="weui-navbar__item weui-bar__item--on" href="{:U('Finance/sub_user_list')}">子用户充值</a>
						</div>
						<div class="weui-tab__bd">
						    ...
						    <div class="weui-panel weui-panel_access">
								<div class="weui-panel__hd"><gt name="list['count']" value="0">用户列表<span class="ml10">共<span><b class="ml5 mr5">{$list['count']}</b></span>个结果</span></gt></div>
							      		...
							      		<div class="weui-popup__modal">
							        		<div class="toolbar">
						          				<div class="toolbar-inner">
								            		...
								            		<h1 class="title">子用户充值</h1>
								          		</div>
								        	</div>
								        	
								        	<div class="modal-content">
												<div class="weui-cells__title">子用户充值</div>
