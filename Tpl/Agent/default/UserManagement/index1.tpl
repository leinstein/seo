...
<script src="../Public/js/jquery/jquery-2.2.1.min.js"></script>
		...
		<div class="row welcome">
			<div class="col-md-12 bordered item1">
				...
				<div class="right">
					...
					<div class="kefu_info">您的专属客服：度桥-陈娇 QQ：2885867584
						电话：13524024355</div>
					...
					<div class="yue_info">
						...
						<p>
							官网通：<span class="num">￥{$funs_info['availablefunds']|format_money}</span> 
