				...
				<div class="weui-tab__bd">
					<div class="weui-tab">
						...
						<div class="weui-navbar">
							<a class="weui-navbar__item" href="{:U('UserManagement/sub_agent_list')}">子代理管理</a>
							<a class="weui-navbar__item weui-bar__item--on" href="{:U('UserManagement/sub_user_list')}">子用户管理</a>
						</div>
						</eq>
						<div class="weui-tab__bd">
						    ...
						    <div class="weui-panel weui-panel_access">
								<div class="weui-panel__hd">用户列表
									<span class="ml10">
										...
										<a href="javascript:;" class="weui-btn weui-btn_primary weui-btn_mini fr open-popup" data-target="#full" style="margin-top: -5px;">添加子用户</a>
									</span>
								</div>
							      		...
							      		<div class="weui-popup__modal">
							        		<div class="toolbar">
						          				<div class="toolbar-inner">
								            		...
								            		<h1 class="title">新增子用户</h1>
								          		</div>
								        	</div>
								        	
								        	<div class="modal-content">
												<div class="weui-cells__title">新增子用户</div>
												<div class="weui-cells weui-cells_form">
													<form name="form" action="{:U('insert')}" method="post">
														<input type="hidden" name="id" id="userid">
														
														<!-- 用户详情 挂件 begin -->
														{:W('UserDetail', array( 'data'=>$data,'operate' => 'insert','skin' => 'mobile','usertype' => 'sub', 'me' => $LoginUserInfo , 'returnUrl' => $CURRENT_URL ))}
														<!-- 用户详情 挂件 end -->
