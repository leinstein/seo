...
<!-- 面包屑导航 begin -->
	<!-- <div class="ui-breadcrumb">
  	...
  	<div class="ui-content" id="ui-content" style="background: #ebf1f3">
		<div class="mt20">
                ...
                <section class="panel">
                    ...
                    <div class="value">
                        <a data-parent="true" data-title="最新达标词数">
                            <h1>{$standard_number|default= 0}</h1>
                      <span>总达标词数</span></a>
                ...
                <section class="panel">
                    ...
                    <div class="value">
                        <a  data-parent="true" data-title="最新首页排位">
                            <h1>{$homerank_number|format_money}</h1>
                      	<span>总首页排位</span>
                      	</a>
                    </div>
                </section>
            ...
            <div class="col-md-3">
                <section class="panel">
                    ...
                    <div class="value">
                        <a data-parent="true" data-title="最新达标词数">
                            <h1>{$standard_number_yesterday|default= 0}</h1>
                      <span>昨日达标词数</span></a>
            ...
            <div class="col-md-3">
                <section class="panel">
                    ...
                    <div class="value">
                        <a  data-parent="true" data-title="最新首页排位">
                            <h1>{$homerank_number_yesterday|format_money}</h1>
                      	<span>昨日首页排位</span>
                      	</a>
                    </div>
                </section>
            ...
            <div class="col-md-3">
                <section class="panel">
                    ...
                    <div class="value">
                        <a data-parent="true" data-title="最新达标词数">
                            <h1>{$standard_number_today|default= 0}</h1>
                      <span>今日达标词数<span class="tip tipso_style" data-tipso="以最新检测时间为准">㊟</span></span></a>
            ...
            <div class="col-md-3">
                <section class="panel">
                    ...
                    <div class="value">
                        <a  data-parent="true" data-title="最新首页排位">
                            <h1>{$homerank_number_today|format_money}</h1>
                      	<span>今日首页排位<span class="tip tipso_style" data-tipso="以最新检测时间为准">㊟</span></span>
                      	</a>
                    </div>
                </section>
            </div>
		...
		<div class="">
            <section class="panel">
                <div class="panel-heading">每日首页排位消耗</div>
