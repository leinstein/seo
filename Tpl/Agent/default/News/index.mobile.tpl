...
<body ontouchstart>
	...
	<div class="header">
		...
		<span class="header__center">系统公告</span>
					...
					<div class="weui-tab">
						...
						<div class="weui-tab__bd">
						    ...
						    <div class="weui-panel weui-panel_access">
								<div class="weui-panel__hd">公告列表<gt name="list['count']" value="0"><span class="ml10">共<span><b class="ml5 mr5">{$list['count']}</b></span>个结果</span></gt></div>
