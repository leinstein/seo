        ...
        <div class="ui-content" id="ui-content">
        	...
        	<div class="ui-panel">	 
				...
				<form class="layui-form" action="{:U('maintain')}" method="post">
					...
					<div class="layui-form-item">
						<label class="layui-form-label required">站点描述</label>
						<div class="layui-input-block">
							<textarea name="sitedesc" lay-verify="required" placeholder="60个字符以内,展示在百度搜索结果创意描述部分" class="layui-textarea">{$data['sitedesc']}</textarea>
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">电脑端网页</label>
						<div class="layui-input-block">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="site_mobile" value="{$data['site_mobile']}" lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
						</div>
					</div>
					<eq name="data['can_edit']" value ="1">
					<div class="layui-form-item">
						<div class="layui-input-block">
