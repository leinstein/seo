...
<body ontouchstart>
	...
	<div class="header">
		...
		<span class="header__center">站点监控</span>
		...
		<div class="page__bd">
			<div class="weui-tab">
				<div class="weui-tab__bd">
					<div class="weui-tab">
						<!-- <div class="weui-navbar">
							...
							<a class="weui-navbar__item" href="{:U('Cart/index')}">关键词清单</a>
							<a class="weui-navbar__item  weui-bar__item--on" href="{:U('Site/effect')}">站点监控</a>
							...
							<div class="weui-search-bar" id="searchBar">
						      <form class="weui-search-bar__form" action="__URL__" >
						        ...
						        <div class="weui-search-bar__box">
						          ...
						          <input type="search" class="weui-search-bar__input" id="searchInput" placeholder="请输入站点名称/站点地址" name="keyword" value="{$Think.get.keyword}">
				...
				<div class="weui-tabbar">
					...
					<a href="{:U('Site/effect')}" class="weui-tabbar__item weui-bar__item--on">
