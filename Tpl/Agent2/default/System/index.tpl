	           	...
	           	<form class="layui-form" name="update_form" action="__URL__/update" enctype="multipart/form-data" method="post" onkeydown="if(event.keyCode==13){return false;}">			
					...
					<!-- <div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="login_page_address"  value="{$data['login_page_address']}" required="" lay-verify="required" placeholder="请填写用户登录网址"  autocomplete="off" class="layui-input">
						</div>
					</div> -->
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline" style="width: 50%;margin-left: 10px;">
							<input type="text" name="page_title"  value="{$data['page_title']}" required="" lay-verify="required" placeholder="请填写系统主页名称"  autocomplete="off" class="layui-input">
						</div>
					...
					<!-- <div class="layui-form-item">
						...
						<div class="layui-input-inline" style="width: 50%;margin-left: 10px;">
							<input type="text" name="product_name"  value="{$data['product_name']}" required="" lay-verify="required" placeholder="请填写产品名称"  autocomplete="off" class="layui-input">
						</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline" style="width: 50%;margin-left: 10px;">
							<input type="text" name="home_page_address"  value="{$data['home_page_address']}" required="" lay-verify="required" placeholder="请填写系统主页地址"  autocomplete="off" class="layui-input">
						</div>
						<div class="layui-form-mid layui-word-aux"></div>
					</div>
					<div class="layui-form-item">
						...
						<div class="layui-input-inline" style="width: 50%;margin-left: 10px;">
							<input type="text" name="customer"  value="{$data['customer']}" required="" lay-verify="required" placeholder="请填写客服名称"  autocomplete="off" class="layui-input">
						</div>
						<div class="layui-form-mid layui-word-aux"></div>
					</div>
					<div class="layui-form-item">
						...
						<div class="layui-input-inline" style="width: 50%;margin-left: 10px;">
							<input type="text" name="telephone"  value="{$data['telephone']}"  required="" lay-verify="my_phone" placeholder="请填写客服联系电话"  autocomplete="off" class="layui-input">
						</div>
