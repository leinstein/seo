		 ...
		 <div class="page__bd">
			...
			<div class="weui-panel weui-panel_access notify">
			  	...
			  	<div class="weui-panel__bd">
				    <a href="mqqwpa://im/chat?chat_type=wpa&uin=3125704179&version=1&src_type=web&web_src=oicqzone.com" class="weui-media-box weui-media-box_appmsg">
				    ...
				    <a href="tel:021-31009706" class="weui-media-box weui-media-box_appmsg">
				      <div class="weui-media-box__hd">
				        <i class="iconfont f18 c_lightblue pl0 pr5">&#xe6d6;</i>
				      </div>
				      <div class="weui-media-box__bd">
