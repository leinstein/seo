...
$(function(){
			...
			<elseif condition="$authtime lt date('Y-m-d')"/>
				var dialogwidth = '500px';
	            var dialogheight = '240px';
			<elseif condition="($Uloancons['count'] eq 0) OR ($Uloancons['count'] gt C('EXPORT_NUM')) " />
				dialogwidth = '500';
		        dialogheight = '150px';
		        contentt = "__GROUP__/TransferTips/limitTips/num/{$Uloancons['count']}";
			</if>
	...
	<div class="wrapper">	
		...
		<div  class="ui-grid-row">
			<div class="ui-grid-25">
				<h2 class="ui-page-title">所有统贷信息</h2>	
			</div>
		</div>
		<!-- 顶部栏目导航 end -->
		...
		<div class="ui-grid-row">
			...
			<div class="ui-grid-20">
					...
					<div class="ui-box-container">
						<ul class="ui-list ui-list-query">
							<li class="ui-list-item">
								<div class="ui-list-item-head">放款金额：</div>
								<div class="ui-list-item-body">
									<div class="param-cont">
										...
										<volist name="Uloanconprameter['p01']" id="v">
								...
								<div class="param-container">
									<div class="param-cont">
										<form name="form" method="get" action="__URL__">
											<input type="hidden" name="m" value="Uloancon"/>
				...
				<!-- 信息提示 begin  -->
			    <div class="ui-banner">
			    	<span class="ui-banner-text">共有 <span class="c_red b">{$Uloancons['count']}</span> 个符合条件的结果 ，清单如下</span> 
				...
				<div class="ui-box mt10 shadow">
				    <div class="ui-box-head">
				        <span class="ui-box-head-text">排序：<a  href="__URL__/index{$query_params}/ord/%/" class="ml5 <if condition="$_GET['ord']==''||$_GET['ord']=='%'">b</if>">默认排序</a> 
				        							        <a href="__URL__/index{$query_params}/ord/loanyear/" class="ml10 <eq name="Think.get.ord" value="loanyear">b</eq>">放款年度</a>  </span>
				...
				<div class="ui-table-container shadow">
				    <table class="ui-table ui-table-follow">
				        ...
				        <tbody>
				        	<volist name="Uloancons['data']" id="vo" mod="2">
				        	<eq name="mod" value="0">
				            <tr>
				            <else/>
				            <tr class="ui-table-split" style="z-index:2;">
			                    ...
			                    {$vo.loanamount|format_money1}</td>
				                <td align="right" style="padding-right:20px;">
				                {$vo.loanover|format_money1}</td>
				                <td>{$vo.expdate}</td>
				                <td>{$vo.loanstatus}</td>
