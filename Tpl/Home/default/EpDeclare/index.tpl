	...
	$('#epd03multireset').click(function(){
		...
		$(function(){
			...
			<elseif condition="$authtime lt date('Y-m-d')"/>
				var dialogwidth = '500px';
	            var dialogheight = '240px';
			<elseif condition="($EpDeclares['count'] eq 0) OR ($EpDeclares['count'] gt C('EXPORT_NUM')) " />
				dialogwidth = '500';
		        dialogheight = '150px';
		        contentt = "__GROUP__/TransferTips/limitTips/num/{$EpDeclares['count']}";
			</if>
	...
	<div class="wrapper">
		...
		<div  class="ui-grid-row">
			<div class="ui-grid-25">
				<h2 class="ui-page-title">所有企业资质</h2>	
			</div>
		</div>
		<!-- 顶部栏目导航 end -->
