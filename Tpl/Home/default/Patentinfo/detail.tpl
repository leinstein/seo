	...
	<div class="wrapper">	
		...
		<div  class="ui-grid-row">
			<div class="ui-grid-25">
				<h2 class="ui-page-title">所有专利项目 > 专利详情</h2>	
			</div>
		</div>
		<!-- 顶部栏目导航 end -->
			...
			<div class="ui-grid-25">
				...
				<div class="ui-box">
				    <div class="ui-box-head">
				        <h3 class="ui-box-head-title">{$Patentinfo.title}详情</h3>
				        <span class="ui-box-head-text"></span>
				        <a href="__APP__/Patentinfo/index" class="ui-box-head-more">返回</a>
				    </div>
				    <div class="ui-box-container">
				        <div class="ui-box-content pt15">
				        	...
				        	<div class="ui-table-container">
							    ...
							    {:W('BusinessDetail',array('tplname'=>'Patentinfo', 'data'=>$Patentinfo))}
							</div>
