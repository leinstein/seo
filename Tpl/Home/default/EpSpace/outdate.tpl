...
<body>
        ...
        <div class="ui-grid-row">
            ...
            <div class = "ui-text-des">
                    您的<span herf="#" style="color:#0088cc" >{$funname}数据导出功能</span>的使用授权截止到<span style="color:red">{$authtime}</span>，已经过期，请重新申请。
            </div>
            <div class = "ui-text-link">
	        	<a class="ui-button ui-button-mblue" href="{:C('funauthApplyUrl')}" target="_parent">申请功能授权</a>
            </div>
        	<!-- 字段信息 end -->
        </div>
        <!-- 全宽布局 end -->
