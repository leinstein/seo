			...
			<div class="ui-grid-24">
				...
				<div class="ui-box ui-box-dialog">
				    <div class="ui-box-head">
				        <h3 class="ui-box-head-title">园区创业投资引导基金跟进投资 详情</h3>
				    ...
				    <div class="ui-box-container">
				        <div class="ui-box-content" style="width:920px; height:420px; overflow:auto;">
				        	<!-- <dl class="ui-dlist ui-dlist-col1">
				        		...
				        		<dt class="ui-dlist-tit">跟投总额：</dt>
							    <dd class="ui-dlist-det">{$data['investsum']|format_money1=2} &nbsp;</dd>
				        		<dt class="ui-dlist-tit">跟投股权份额（%）：</dt>
							    <dd class="ui-dlist-det">{$data['stake']} &nbsp;</dd>
							    <dt class="ui-dlist-tit">已出资额：</dt>
							    <dd class="ui-dlist-det">{$data['actfundsum']|format_money1=2} &nbsp;</dd>
							    <dt class="ui-dlist-tit">主投资方：</dt>
							    <dd class="ui-dlist-det">{$data['maorgname']} &nbsp;</dd>
				        	</dl>
				        	<dl class="ui-dlist ui-dlist-col2">
				        		<dt class="ui-dlist-tit">主投金额：</dt>
							    <dd class="ui-dlist-det">{$data['maorgfunsum']|format_money1=2} &nbsp;</dd>
				        		...
				        		<dt class="ui-dlist-tit">退出回收资金：</dt>
			        		...
			        		<!-- content 引导基金跟投  begin -->
							{:W('BusinessDetail',array('tplname'=>'YdjjInvest', 'data'=>$data))}
							<!-- content 引导基金跟投  end -->
				        </div>
				    </div>
				</div>
