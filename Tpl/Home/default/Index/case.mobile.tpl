...
<body ontouchstart>
	...
	<div class="header">
		...
		<span class="header__center">成功案例</span>
	...
	<div class="page" >
		<div class="page__bd">	
			<div class="weui-search-bar" id="searchBar">
		      <form class="weui-search-bar__form" action="__URL__" >
		        ...
		        <div class="weui-search-bar__box">
		          ...
		          <input type="search" class="weui-search-bar__input" id="searchInput" placeholder="请输入关键词" name="keyword" value="{$Think.get.keyword}">
		    ...
		    <div class="weui-panel weui-panel_access">
				<div class="weui-panel__hd">关键词列表</div>
				<div class="weui-panel__bd">
				
					<div id="content_div">
			 			<!-- 嵌套数据模版 begin -->
			            <include file="tpl/case.mobile"/>
			            <!-- 嵌套数据模版 end -->
					</div>
