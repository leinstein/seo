	...
	<!-- <div class="ui-breadcrumb">
  	...
  	<div class="ui-content" id="ui-content" style="background: #ebf1f3">
		...
		<div class="mt15">
            <div class="col-md-3">
                <section class="panel">
                    <div class="symbol bgcolor-blue" style="background: #ff9900">我的网站</div>
                    <div class="value">
            ...
            <div class="col-md-3">
                <section class="panel">
                    <div class="symbol bgcolor-commred" style="background: #a6325a" >我的关键词</div>
                    <div class="value">
            ...
            <div class="col-md-3">
                <section class="panel">
                    <div class="symbol bgcolor-dark-green" style="background: #48a7c2">上首页关键词</div>
                    <div class="value">
            ...
            <div class="col-md-3">
                <section class="panel">
                    <div class="symbol bgcolor-yellow-green" style="background: #4fb3a4">上词率</div>
                    <div class="value">
            ...
            <div class="col-md-3">
                <section class="panel">
                    <div class="symbol bgcolor-orange" style="background: #f5b977">今日消费</div>
                    <div class="value">
            ...
            <div class="col-md-3">
                <section class="panel">
                    <div class="symbol bgcolor-orange" style="background: #4fb3a4">累计消费</div>
                    <div class="value">
                ...
                <section class="panel">
                    ...
                    <div class="value">
                        <a data-parent="true" data-title="可用金额">
                            <h1>{$funds_pool['availablefunds']|format_money}</h1>
                      	<span>可用金额</span>
                      	</a>
                    </div>
                </section>
