...
<nav class="ui-menu">
	<ul class="layui-nav layui-nav-tree" lay-filter="menu">
		...
		<li class="layui-nav-item <if condition="MODULE_NAME  eq 'QRIndex' && ACTION_NAME eq 'index'">layui-nav-itemed</if>">
		...
		<li class="layui-nav-item <if condition="MODULE_NAME  eq 'QRKeyword' ||  MODULE_NAME  eq 'QRReport' ">layui-nav-itemed</if>">
