        ...
        <div class="ui-content" id="ui-content">
        	...
        	<div class="ui-panel">	 
	        	...
	        	<blockquote class="layui-elem-quote">
                    资金池总额: <span>{$data['totalfunds']|format_money}元</span>
                    资金池余额: <span>{$data['balancefunds']|format_money}元</span>
                    资金池可用余额: <span>{$data['availablefunds']|format_money}元</span>
                    资金池消费金额: <span>{$data['consumptionfunds']|format_money}元</span>
                    资金池剩余冻结金额: <span>{$data['freezefunds']|format_money}元</span>
                </blockquote>
	            <!-- 账户余额区域 begin -->
