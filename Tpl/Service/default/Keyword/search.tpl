							...
							<tbody>
								...
								<tr <eq name="vo['isrecommend']" value="1"> class="hidden1" </eq> id="tr{$key}">
									<td style="text-align:left">
										<input type="checkbox" name="check[]" checked value="{$vo['keyword']}::11000::{$vo['baidu']},{$vo['baidu_mobile']},0,0,0" class="keyword" style=" vertical-align: text-bottom;margin-top: 4px;">
										&nbsp;&nbsp;{$vo['keyword']}
									</td>
