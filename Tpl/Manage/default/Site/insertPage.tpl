...
<!--主题css-->
<link rel="stylesheet" type="text/css"
	href="../Public/css/themes/default.css" id="skin-switcher">
<!--响应式css-->
<link rel="stylesheet" type="text/css"
								...
								<form name="form1" action="{:U('insert')}" method="post"
									...
									<div class="form-group">
										<label>站点名称</label> <input type="text" class="form-control"
											name="sitename" id="wzname" value="" required="">
									</div>
									<div class="form-group">
										<label>网址</label> <input type="text" class="form-control"
											name="website" id="url" value="" required=""
											placeholder="请按照格式填写，如：www.baidu.com">

									</div>
									<div class="form-group">
										<label>ftp</label>
										<textarea name="ftp" id="ftp" class="form-control"
											placeholder="请准确FTP信息,以便优化师调整"></textarea>
									</div>
									<div class="form-group">
										<label>管理后台</label>
										<textarea name="glht" class="form-control"
											placeholder="请填写后台管理账号,以便优化师调整"></textarea>
									</div>
