   	...
   	function exportReport(){
		...
		layer_confirm('导出数据可能会比较缓慢，您确认导出么？',
			function () {
				...
				window.location.href = "__URL__/export_cooperate_stop_all";
						...
						<div class="layui-form-item">
						    ...
						    <div class="layui-inline">
						      <div class="layui-input-inline">
						        ...
						        <button type="reset" name="btn" onclick="location.href='__URL__/全部'" class="layui-btn layui-btn-primary">重置</button>
						      </div>
						    </div>
						  </div>
						</form> -->
