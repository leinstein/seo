						...
						<tr>
							...
							<td>
								<volist name="vo['roles'][0]['user_info']" id="vo_user" >
									<a class="m10" style="display: block;" href="javascript:;" onclick="open_layer('修改用户信息','{:U('updateStaffPage')}/id/{$vo_user['id']}/rolecode/{$vo['roles'][0]['rolecode']}/rolelevel/{$vo['roles'][0]['rolelevel']}&returnUrl={$CURRENT_URL}','50%')" >{$vo_user['username']}</a>
								</volist>
							</td>
							
							<td>
								<!-- <a href="{:U('insertStaffPage')}/rolecode/{$vo['roles'][0]['rolecode']}" >添加员工</a> -->
								<a class="layui-btn layui-btn-mini" href="javascript:;" onclick="open_layer('添加员工','{:U('insertStaffPage')}/rolecode/{$vo['roles'][0]['rolecode']}/rolelevel/{$vo['roles'][0]['rolelevel']}&returnUrl={$CURRENT_URL}','50%')" >添加员工</a>
						...
						<tr>
							...
							<td>
								<volist name="vo2['user_info']" id="vo_user2" >
									<a class="m10" style="display: block;" href="javascript:;" onclick="open_layer('修改用户信息','{:U('updateStaffPage')}/id/{$vo_user2['id']}/rolecode/{$vo2['rolecode']}/rolelevel/{$vo2['rolelevel']}&returnUrl={$CURRENT_URL}','50%')" >{$vo_user2['username']} </a>
								</volist>
							</td>
							<td>
								<!-- <a href="{:U('insertStaffPage')}/rolecode/{$vo2['rolecode']}" >添加员工</a> -->
								<a class="layui-btn layui-btn-mini" href="javascript:;" onclick="open_layer('添加员工','{:U('insertStaffPage')}/rolecode/{$vo2['rolecode']}/rolelevel/{$vo2['rolelevel']}&returnUrl={$CURRENT_URL}','50%')" >添加员工</a>
