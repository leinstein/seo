...
<div class="layui-tab-content">
	<form name="form" action="{:U('setRank')}" method="post" class="layui-form">
		<input type="hidden" name="id" value="{$Think.get.id}">
		<input type="hidden" name="original_rank" value="{$Think.get.rank}">
		<input type="hidden" name="day" value="{$Think.get.day}">
		<input type="hidden" name="returnUrl" value="{$Think.get.returnUrl}"> 
		
		<div class="layui-form-item layui-form-text">
			<label class="layui-form-label">达标日期</label>
			<div class="layui-input-block">
				<input type="text" value="{$Think.get.day}" readonly="readonly" class="layui-input">
			</div>
		</div>
		...
		<div class="layui-form-item layui-form-text">
			...
			<div class="layui-input-block">
				<input type="text" value="{$Think.get.original}" readonly="readonly" class="layui-input">
			</div>
		</div>
