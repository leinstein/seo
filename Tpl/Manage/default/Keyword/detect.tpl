...
<!--datepicker插件-->
<link rel="stylesheet" type="text/css"
	href="../Public/js/bootstrap-daterangepicker/daterangepicker-bs3.css">
<!-- FONTS -->
<!--字体-->
<script type="text/javascript"
	src="../Public/js/easydialog/easydialog.min.js"></script>
<link href="../Public/js/easydialog/easydialog.css" rel="stylesheet"
	type="text/css">

<script type="text/javascript"
	src="../Public/js/My97DatePicker/WdatePicker.js"></script>
<link href="../Public/js/My97DatePicker/skin/WdatePicker.css"
												...
												<tbody>
													...
													<tr class="gradeA odd">
														...
														<td class="center">
															...
															<a class="btn btn-primary btn-xs" href="__URL__/reviewPage/id/{$vo['id']}">审核</a>
															<else/>
															<button type="button" class="btn btn-default btn-xs no-drop" disabled="disabled" style="background-color:#9e9e9e;">审核</button>
															</eq>
															<!-- <a onclick="return confirm(&quot;确定审核通过吗?&quot;)" class="btn btn-primary btn-xs" href="__URL__/review/id/{$vo['id']}/conclusion/pass">审核通过</a>
															<a onclick="return confirm(&quot;确定审核不通过?&quot;)" class="btn btn-danger btn-xs" href="__URL__/review/id/{$vo['id']}/conclusion/notpass">审核不通过</a> -->
