            ...
            <form class = "layui-form"
                ...
                <div class = "layui-form-item">
                    ...
                    <div class = "layui-input-inline">
                        ...
                        <div class = "layui-input-inline" style="display: inline">
                                <input type = "text"
                                       name = "bp_price"
                              <if condition="$data['bp_price'] eq 0">value=""<else />value = "{$data.bp_price}" disabled="disabled"</if>
                                   placeholder = "请填写霸屏价格"
                                   autocomplete = "off"
                                   class = "layui-input">
                        </div>
                ...
                <?php if ($LoginUserInfo['role_info']['id'] == '2') { ?>
                    <div class = "layui-form-item">
                        ...
                        <div class = "layui-input-inline">
                            <select first = "请审核"
                                    name = "bp_check" <?php if ($data['bp_check'] == '1' || $data['bp_check'] == '2'){
                                        echo 'disabled';
                            }; ?>>
                                <option
                ...
                <div class = "layui-form-item"  style="margin-top: 30px">
                    <div class = "layui-input-block">
                        <button class = "layui-btn"
                                lay-submit = ""
                                lay-filter = "go"><?php if ($data['bp_check'] == '1'||$data['bp_check'] == '2')
                            {
                                echo '更新';
                            }else{
                                echo '审核';
                        ...
                        <if condition="$data['bp_check'] == '1'">
                            <a href="/Manage/System/tuitecheckRecord?id={$data['id']}" style="margin-left: 50px">
