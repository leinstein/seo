					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<!-- <a class="layui-btn layui-btn-mini" href="javascript:;" onclick="open_layer('修改子用户密码','{:U('updatePasswordPage')}/id/{$vo['id']}/type/agent','50%')" >密码</a>
								<a class="layui-btn layui-btn-mini" target="_blank" href="__URL__/loginSubuser/userid/{$vo['id']}">登录</a>
								<a href="javascript:;" onclick="open_layer('日志','{:U('updatePasswordPage')}/id/{$vo['id']}/type/agent','50%')" >日志</a>
