						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									<div class="clearfix">
										<h3 class="content-title pull-left">关键词清单</h3>
									</div>
										...
										<div id="datatable2_wrapper"
											...
											<div class="buy_tip">
												<span style="line-height: 30px">购买须知:<br>1.为了确保关键词效果,系统将按照站点下所购买关键词30天的达标费用作为预付款进行冻结,冻结资金依然在您的账户中,但无法再次购买其他关键词。<br>
													...
													href="/help_article.php?id=44">《优站宝服务协议》</a></span>
											</div>
	...
	<script>
	 ...
	 function buy(id) {
	        ...
	        if( confirm('您确定购买该关键词？')){
		        ...
		        var url = "__URL__/buy/id/" + id + "/siteid/" + siteid + "/request_type/ajax";
    ...
    function buyBatch() {
      ...
      var ids = getChecked();
       ...
       if( confirm('关键词删除后不可恢复，您确定删除？')){
	        ...
	        var url = "__URL__/buy/id/" + ids + "/siteid/" + siteid + "/request_type/ajax";
	      	//window.location.href= url;return false;
      	$.ajax({
              type: "get",
              url: url,
