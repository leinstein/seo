				...
				<div class="right">
					<div class="user_info">
						<span class="username blue">{$LoginUserName}，欢迎您！</span>
						 <span>您的账户类型:<span class="blue">普通用户</span></span>
					...
					<div class="yue_info">
						...
						<p>
							{$LoginUserInfo['oem_config']['product_name']|default='优站宝'}：<span class="num">￥{$funs_info['availablefunds']|format_money}</span> 
			...
			<!-- <div class="col-md-3 list_lh">
				<dl class="news_center bordered item2">
					...
					<dd class="clearfix" style="">
						...
						<a class="title pull-left">关于{$LoginUserInfo['oem_config']['product_name']|default='优站宝'}关键词价格...</a> <span
							class="date pull-right">2016-11-17</span>
					</dd>
					<dd class="clearfix" style="">
						href="/help_article.php?id=34"
						<a class="title pull-left">启搜宝系统-{$LoginUserInfo['oem_config']['product_name']|default='优站宝'}系统...</a> <span
					...
					<dd class="clearfix" style="">
						...
						<a class="title pull-left">启搜宝系统 {$LoginUserInfo['oem_config']['product_name']|default='优站宝'}V1...</a> <span
							class="date pull-right">2016-06-15</span>
					</dd>
					<dd class="clearfix" style="">
				...
				<div class="box table-bordered">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<tr>
								<td>{$LoginUserInfo['oem_config']['product_name']|default='优站宝'}</td>
