...
<head>
    ...
    <title> {$page_title|default="智能营销系统"}</title>
    <!-- Bootstrap -->
...
<body>
    <div class="container-fluid">
        <div class="login">
            <if condition="$logo_image_url">
                <div class="m-logo"><img src="{$logo_image_url}" alt=""></div>
                <else />
                <div class="m-logo"><img src="__PUBLIC__/static/login/images/m_logo.png" alt=""></div>
            </if>
    ...
    <if condition="$logo_image_url">
        <script>
            $("body").css("background-image","url('{$login_page_image_url}' )");
        </script>
        <else />
