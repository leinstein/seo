<!-- <form class="layui-form layui-form-pane1" name="form1" id="form1" method="get" action="__URL__" class="form-inline" style="margin-bottom: 15px;">
    ...
    <tr>
		...
		<!--<th>检测时间<th>-->
		<th width="50">初始排名</th>
		<th width="50" title="数据以最新监测时间为准"><a href="__URL__/effect/ord/latestranking{$query_params}">最新排名</a></th>
	...
	<tbody>
	    ...
	    <tr>
			...
			<td><a href="javascript:void(0);" onclick="open_layer('查看详情','{:U('history')}/id/{$vo['id']}',600,680)" class="layui-btn layui-btn-mini">查看详情</a></td>
