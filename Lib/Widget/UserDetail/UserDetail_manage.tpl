...
<div class="layui-form-item">
	...
	<div class="layui-input-block">
		...
		<html:select options="sale_codeSet" first="请选择" name="seller_id" selected="data['seller_id']" />
...
<input type="hidden" name="usergroup" value="{$Think.get.usergroup|default=$data['usergroup']}">
