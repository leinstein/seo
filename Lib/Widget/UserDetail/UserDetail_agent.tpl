...
<div class="layui-form-item">
	...
	<div class="layui-input-block">
		...
		<input type="text" name="username" id="username" required="" lay-verify="required" placeholder="请填写用户登录名" autocomplete="off" class="layui-input">
		<else/>
...
<eq name="Think.get.usertype" value="agent">
...
<div class="layui-form-item" pane="">
    ...
    <div class="layui-input-block">
	    <volist name="products" id="vo">
	    	...
	    	<input type="checkbox" name="product[]" lay-skin="primary" title="{$vo['product_name']}" lay-verify="required" checked="" disabled="">
	    	<input type="hidden" name="product[]" value="{$vo['id']}">
	    	<else/>
	    	<input type="checkbox" name="product[]" lay-skin="primary" title="{$vo['product_name']}" lay-verify="required"  value="{$vo['id']}" 
			<eq name="vo['checked']" value="1">  checked=""  </eq>
	    	>
	    	</eq> 
	    </volist>
    </div>
