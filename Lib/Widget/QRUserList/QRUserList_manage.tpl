...
<h3 class="rwgl mb20">
 	<a href="javascript:;" onclick="open_layer('添加代理商用户','{:U('insertPage')}/usertype/agent/usergroup/Agent/&returnUrl={$returnUrl|urlencode}','50%')" class="layui-btn"><i class="iconfont icon-jia"></i> 添加代理商</a>
 </h3>	
 </eq>
	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<a class="layui-btn layui-btn-mini"  href="javascript:;" onclick="open_layer('修改代理商用户','{:U('updatePage')}/id/{$vo['id']}/usertype/agent&returnUrl={$returnUrl|urlencode}','50%')" >修改</a>
				<a class="layui-btn layui-btn-mini"  href="javascript:;" onclick="open_layer('修改代理商用户密码','{:U('updatePasswordPage')}/id/{$vo['id']}/usertype/agent&returnUrl={$returnUrl|urlencode}','50%')" >密码</a>
