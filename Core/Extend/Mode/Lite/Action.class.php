...
abstract class Action {
   ...
   /**
     ...
     * @return void
     +----------------------------------------------------------
     */
    protected function success($message,$jumpUrl='',$ajax=false,$parent =false) {
    	dump($parent);exit;
        $this->dispatchJump($message,1,$jumpUrl,$ajax,$parent);
    }
     ...
     * @return void
     +----------------------------------------------------------
     */
    private function dispatchJump($message,$status=1,$jumpUrl='',$ajax=false,$parent =false) {
        // 判断是否为AJAX返回
