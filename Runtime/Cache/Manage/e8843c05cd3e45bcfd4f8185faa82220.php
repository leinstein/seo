...
<div class="layui-tab-content">
	<form name="form" action="<?php echo U('setInitRank');?>" method="post" class="layui-form">
		...
		<div class="layui-form-item layui-form-text">
			...
			<div class="layui-input-block">
				<input type="text" value="<?php echo ($rank_original); ?>" readonly="readonly" class="layui-input">
			</div>
		</div>
