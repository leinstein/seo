...
<!-- 只显示未读消息模式 -->
<?php if(!empty($users_less)): ?><script>
//加载
$(function(){
    ...
    <div class="ui-panel-container">
        <div class="ui-panel-content">
        	<ul class="ui-user-notify">
				<?php if(is_array($users_less)): $i = 0; $__LIST__ = $users_less;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="ui-notify-item not-read notify_<?php echo ($vo['id']); ?>">
					<i class="iconfont f18 c_lightblue pl0 pr5">&#xe6bc;</i><span>用户<b class="ml10 mr10"><?php echo ($vo['username']); ?></b>资金池余额小于一周的消耗，请提醒续费！</span>
