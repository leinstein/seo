...
<div class="layui-tab-content">
	<form name="form" action="<?php echo U('review');?>" method="post" class="layui-form">
		...
		<div class="layui-form-item layui-form-text">
			...
			<div class="layui-input-block">
				<textarea name="reviewopinion" placeholder="请填写审核意见" class="layui-textarea" lay-verify="reviewopinion" ><?php echo ($data['reviewopinion']); ?></textarea>
			</div>
		</div>
