...
layui.use(['element'], function(){
    ...
    <div class="ui-module">	
        ...
        <div class="ui-content" id="ui-content">
	        ...
	        <div class="ui-panel">
	        	<?php if(!empty($users_less)): ?><blockquote class="layui-elem-quote mt20">
					<?php if(is_array($users_less)): $i = 0; $__LIST__ = $users_less;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><p><i class="iconfont f18 c_lightblue pl0 pr5">&#xe6bc;</i><span>用户<b class="ml10 mr10"><?php echo ($vo['username']); ?></b>资金池余额小于一周的消耗，请提醒续费！</span></p><?php endforeach; endif; else: echo "" ;endif; ?>
					
				</blockquote><?php endif; ?>
	            <!-- 用户列表挂件 begin -->
	       		<?php echo W('UserList', array( 'list' => $list, 'skin' => 'sub' , 'returnUrl' => $CURRENT_URL, 'me' => $LoginUserInfo));?>
				<!-- 用户列表挂件 end -->	
			</div>
