        ...
        <div class="ui-content" id="ui-content">
	        ...
	        <div class="ui-panel" style="height: 595px;">
				<blockquote class="layui-elem-quote bg-info">
					总用户： <span><?php echo (($total_num)?($total_num):0); ?></span>
					有效用户：<span class="danger"><?php echo (($active_num)?($active_num):0); ?></span>
					无效用户：<span><?php echo (($invalid_num)?($invalid_num):0); ?></span>
					资金池低于10000 的用户：<span><?php echo (($pool_less10000)?($pool_less10000):0); ?></span>
				</blockquote>           
	            <!-- 站点效果挂件 begin -->
	       		<?php echo W('UserList', array( 'list' => $list, 'skin' => 'manage', 'returnUrl' => $CURRENT_URL));?>	
				<!-- 站点效果挂件 end -->	
			</div>
