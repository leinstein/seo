...
<!--menu 左侧菜单 end -->
    ...
    <div class="ui-module">
        ...
        <div class="ui-content" id="ui-content">
        	<div class="ui-panel">	 
        		<form  name="update_form" class="layui-form" action="__URL__/updatePassword" method="post" onkeydown="if(event.keyCode==13){return false;}">
...
<div class="layui-form-item">
	...
	<div class="layui-input-block">
		<input type="password" id="newpassword2" name="newpassword2"  required lay-verify="newpassword2" placeholder="请再次输入您的新密码"  autocomplete="off" class="layui-input">
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<button class="layui-btn" lay-submit="" lay-filter="go">修改账号密码</button>
							</div>
						</div>
					</form>
			</div>
