        	...
        	<div class="ui-panel">	 
				...
				<div class="layui-tab layui-tab-brief">
				  <ul class="layui-tab-title">
				    <li class="layui-this">入账记录<i class="iconfont ml5" style="font-size: 20px;">&#xe66f;</i></li>
				  ...
				  <div class="layui-tab-content">
				    <div class="layui-tab-item layui-show">
				       	<table class="layui-table">
							...
							<tbody>
								<?php if(!empty($list_agent['data'])): if(is_array($list_agent['data'])): $i = 0; $__LIST__ = $list_agent['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				    ...
				    <div class="layui-tab-item">
				       	<table class="layui-table">
							...
							<tbody>
								<?php if(!empty($list_sub['data'])): if(is_array($list_sub['data'])): $i = 0; $__LIST__ = $list_sub['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									<td><?php echo ($vo['No']); ?></td>
