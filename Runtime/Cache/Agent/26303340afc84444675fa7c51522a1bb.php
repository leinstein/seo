...
<div class="layui-form-item">
	...
	<div class="layui-input-block">
		<?php if(($operate) == "insert"): ?><input type="text" name="username" id="username" required="" lay-verify="required" placeholder="请填写用户登录名" autocomplete="off" class="layui-input">
		<?php else: ?>
...
<?php if(($_GET['usertype']) == "agent"): ?><div class="layui-form-item">
