...
<div class="layui-form-item">
	...
	<div class="layui-form-mid"><?php echo ($LoginUserName); ?></div>
	</div>
</div>
<div class="layui-form-item">
	<label class="layui-form-label">邮箱地址</label>
	<div class="layui-input-block">
		<input type="text" name="email" value="<?php echo ($LoginUserInfo['email']); ?>" placeholder="请输入常用邮箱,用于平台通知、密码找回"  autocomplete="off" class="layui-input">
		<!-- <input type="text" name="email" value="<?php echo ($LoginUserInfo['email']); ?>" lay-verify="email"  placeholder="请输入常用邮箱,用于平台通知、密码找回"  autocomplete="off" class="layui-input"> -->
	</div>
</div>
<div class="layui-form-item">
	<label class="layui-form-label">公司名称</label>
	<div class="layui-input-block">
		<input type="text" name="epname" value="<?php echo ($LoginUserInfo['epname']); ?>" required="" lay-verify="required" placeholder="公司名称,请填写营业执照公司全称"  autocomplete="off" class="layui-input">
	</div>
</div>
...
<div class="layui-form-item">
	...
	<div class="layui-input-block">
		<input type="text" name="contact" value="<?php echo ($LoginUserInfo['contact']); ?>" placeholder="您的真实姓名"  autocomplete="off" class="layui-input">
	</div>
</div>
...
<div class="layui-form-item">
	...
	<div class="layui-input-block">
		<input type="text" name="QQnumber" value="<?php echo ($LoginUserInfo['QQnumber']); ?>"  lay-verify="number" placeholder="方便在线沟通"  autocomplete="off" class="layui-input">
	</div>
</div>
...
<div class="layui-form-item">
	...
	<div class="layui-input-block">
		<input type="text" name="telephone" value="<?php echo ($LoginUserInfo['telephone']); ?>"  placeholder="便于沟通"  autocomplete="off" class="layui-input">
	</div>
</div>
<div class="layui-form-item">
	<label class="layui-form-label">手机号码</label>
	<div class="layui-input-block">
		<input type="text" name="mobileno" value="<?php echo ($LoginUserInfo['mobileno']); ?>" lay-verify="phone" placeholder="联系手机"  autocomplete="off" class="layui-input">
	</div>
</div>
