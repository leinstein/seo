    ...
    <div class="ui-module">
        ...
        <div class="ui-content" id="ui-content">
        	...
        	<div class="ui-panel">
        		...
        		<h3 class="rwgl mb20">
			 		<a class="layui-btn" href="javascript:;" onclick="open_layer('添加站点','<?php echo U('insertPage');?>?','50%')"><i class="iconfont">&#xe68b;</i> 添加站点</a>
			 	</h3>	
			 	
	        	<!-- 站点列表挂件 begin -->
				<?php echo W('SiteList', array( 'list' => $list,'query_params'=>$query_params, 'untreated_workorder_num' => $untreated_workorder_num, 'me' => $LoginUserInfo, 'returnUrl' => $CURRENT_URL));?>
				<!-- 站点列表挂件 end -->	
