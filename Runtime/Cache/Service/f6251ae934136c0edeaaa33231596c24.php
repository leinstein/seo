            ...
            <form class = "layui-form"
                ...
                <div class = "layui-form-item">
                    ...
                    <div class = "layui-input-inline"
                        ...
                        <input type = "text"
                               ...
                               class = "layui-input"
                               lay-verify = "required"
                            <?php if ($data['bp_check'] == '1') { echo 'readonly'; }; ?>>
                    </div>
                </div>
                <div class = "layui-form-item">
                ...
                <div class = "layui-form-item">
                    ...
                    <div class = "layui-input-inline"
                        ...
                        <a class = "sel_btn  ch_cls"
                           href = "/Manage/Upload/downloadFile/id/92">点击下
                            载模板文档</a>
                    </div>
                </div>
                    <?php } ?>
                ...
                <div class = "layui-form-item">
                    ...
                    <div class = "layui-input-inline">
                        <select first = "请选择套餐种类"
                                name = "bp_combo" <?php if ($data['bp_check']=='1'){ echo 'disabled'; } ?>>
                            <option
                ...
                <div class = "layui-form-item">
                    <div class = "layui-input-block">
                        <?php if ($data['bp_check']!=='1'&& $data['bp_check']!=='3'){ ?>
