...
return array(
	//配置项 'key' => 'value'
		...
		// 海排报表导出配置
		'QR_REPORT_EXPORT_CONFIG' => array(
				array('fieldname'=>'No','caption'=>'序号','visible'=>'1','width'=>'10','type'=>'string'),
				array('fieldname'=>'keyword','caption'=>'关键词','visible'=>'1','width'=>'35','type'=>'string'),
				array('fieldname'=>'searchengine','caption'=>'搜索引擎','visible'=>'1','width'=>'15','type'=>'string'),
				array('fieldname'=>'rank','caption'=>'排名','visible'=>'1','width'=>'15','type'=>'string'),
				array('fieldname'=>'snapshot','caption'=>'快照','visible'=>'1','width'=>'85','type'=>'string'),
				array('fieldname'=>'detecttime','caption'=>'检测时间','visible'=>'1','width'=>'25','type'=>'string'),
		),
		
		// 优站宝导出配置 cooperate_stop_today
		'OS_KEYWORD_REPORT_EXPORT_CONFIG' => array(
				array('fieldname'=>'No','caption'=>'序号','visible'=>'1','width'=>'10','type'=>'string'),
				array('fieldname'=>'keyword','caption'=>'关键词','visible'=>'1','width'=>'35','type'=>'string'),
				array('fieldname'=>'searchengine_zh','caption'=>'搜索引擎','visible'=>'1','width'=>'15','type'=>'string'),
				array('fieldname'=>'website','caption'=>'网址','visible'=>'1','width'=>'50','type'=>'string'),
				array('fieldname'=>'createtime','caption'=>'添加时间','visible'=>'1','width'=>'25','type'=>'string'),
		),
);
?>